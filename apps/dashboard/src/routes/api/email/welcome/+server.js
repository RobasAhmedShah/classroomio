...
export async function POST({ request }) {
  ...
  const emailData = [
    {
      from: `"Best from Learnova" <notify@mail.Learnova.com>`,
      to,
      subject: 'Welcome to Learnova!',
      content: `
    <p>Dear ${name},</p>
      <p>My name is Best, the founder of Learnova. I saw you signed up, any questions so far?</p>
      <p>
      ...
      <div>
        <a href="https://peopletalk.io/demo">Book demo</a>
      </div>
      <p>
