    ...
    <div class="flex justify-center items-center flex-col w-9/12 max-w-md">
      ...
      <div class="flex flex-col items-center">
        <div class="flex items-center w-full justify-center mb-4">
          <img src="/logo-192.png" alt="Learnova logo" height="50" width="50" data-atf="1" />
          <h4 class="dark:text-white text-xl">Learnova</h4>
        </div>
        ...
        {#if step === 1}
          ...
          <div id="role-question" class="flex items-start flex-col mb-6">
            ...
            <TextField
              ...
              helperMessage={`https://${fields.siteName || ''}.Learnova.com`}
