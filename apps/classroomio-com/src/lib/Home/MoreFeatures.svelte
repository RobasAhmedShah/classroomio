<script lang="ts">
  ...
  const moreFeatures = [
    ...
    },
    {
      ...
      description:
        'Extend invitations and manage your teaching institution seamlessly through LearnovaAi.',
  ...
  <div class="mx-0 lg:mx-[12%]">
    <div class="w-full lg:w-4/5 mx-4 lg:mx-0 mb-14">
      ...
      <p class="mt-4 text-lg text-gray-500 w-[94%] lg:w-4/5">
        LearnovaAi is packed with useful features while we try to make it easy to use.
      </p>
    </div>
