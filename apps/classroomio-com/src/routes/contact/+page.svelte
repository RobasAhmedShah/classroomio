  ...
  const formList = [
    {
      ...
      to: 'https://github.com/Learnova/Learnova/issues/new?assignees=&labels=bug&projects=&template=bug-report.yml'
    },
    {
      id: FORM_TYPE.HELP,
      title: '🙋‍♂️  I need help'
    },
    {
      ...
      to: 'https://github.com/Learnova/Learnova/issues/new?assignees=&labels=&projects=&template=feature-request.yml'
    },
    {
...
<svelte:head>
  <title>Contact us | Learnova</title>
</svelte:head>
