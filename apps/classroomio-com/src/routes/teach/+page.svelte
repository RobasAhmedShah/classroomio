<script lang="ts">
  ...
  const steps = [
    {
      title: 'Sign up',
      subText: 'Create a free account on our platform by going to LearnovaAi.com/signup'
    },
    {
  ...
  let faqs = [
    {
      question: 'What kind of tutors does LearnovaAi look for?',
      answer:
    ...
    {
      question: 'What equipment do I need to teach on LearnovaAi?',
...
<svelte:head>
  <title>Teach | LearnovaAi</title>
  <meta property="og:image" itemprop="image" content="https://brand.cdn.clsrio.com/og/teach.png" />
  <meta property="og:title" content="Teach on LearnovaAi" />
  <meta
    property="og:description"
    content="On LearnovaAi you can make side income while doing what you love."
  />
  ...
  <meta name="twitter:title" content="Teach on LearnovaAi" />
  <meta
  ...
  <PageHeader className="flex items-center justify-evenly px-5 flex-wrap text-left">
    <div>
      ...
      <p class="my-5 lg:w-[77%] lg:text-left text-center">
        With LearnovaAi, you can make side income while teaching the subject you love
      </p>
    ...
    <div class="px-2 lg:px-[12%] bg-[#F5F8FE] my-10 py-12 h-[75%] lg:h-[80%]">
      ...
      >
        <h1 class="text-base font-medium leading-5 w-[77%] mx-auto">
          With LearnovaAi, I am training over 100 students. I am making more money than expected
