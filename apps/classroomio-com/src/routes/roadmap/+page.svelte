<script>
  ...
  const upcomingFeatures = [
    ...
    {
      title: 'API',
      desc: 'We are working on our public API which allows you to perform CRUD operations against your Learnova organization.'
    },
    {
      title: 'Embedable Course',
      desc: 'You can embed selected course form Learnova on any website of your choice'
    },
    {
...
<PageHeader className="flex flex-col items-center justify-center text-center">
  ...
  <p class="text-start md:text-center w-[80%] md:w-[40%] text-slate-700 mt-10">
    ...
    feature requests and ideas that we're considering, check out our <a
      href="https://github.com/rotimi-best/Learnova/discussion"
