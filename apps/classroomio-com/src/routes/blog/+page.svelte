...
<section>
  <PageHeader className="flex flex-col items-center justify-center text-center">
    ...
    >
      ...
      <span class="text-blue-700 relative">LearnovaAi?</span>
    </h1>
    <p class="w-[90%] md:w-[60%] text-center font-normal text-lg text-slate-700 mt-10 lg:mt-7">
      Get the latest news from LearnovaAi, including product updates, team announcements and more!
    </p>
  </PageHeader>
