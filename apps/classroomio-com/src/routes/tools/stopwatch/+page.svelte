...
<svelte:head>
  <title>Activity Stopwatch | Learnova</title>
  <meta
    property="og:image"
    itemprop="image"
    content="https://brand.cdn.clsrio.com/og/free-tools.png"
  />
  <meta property="og:title" content="Activity Stopwatch | Learnova" />
  <meta
  ...
  <meta name="twitter:title" content="Activity Stopwatch | Learnova" />
  <meta
