...
<svelte:head>
  <title>Pomodoro Timer | LearnovaAi</title>
  <meta property="og:image" itemprop="image" content="" />
  <meta property="og:title" content="Pomodoro Timer | LearnovaAi" />
  <meta
  ...
  <meta name="twitter:title" content="Pomodoro Timer | LearnovaAi" />
  <meta
