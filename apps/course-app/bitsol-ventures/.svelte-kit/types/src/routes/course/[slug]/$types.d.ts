...
type LayoutRouteId = RouteId | "/course/[slug]" | "/course/[slug]/[section]/[filename]"
type LayoutParams = RouteParams & { slug?: string; section?: string; filename?: string }
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/course/[slug]/+layout.server.js').load>>>>>>;
