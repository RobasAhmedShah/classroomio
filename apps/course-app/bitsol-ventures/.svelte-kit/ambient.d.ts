...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_carbon_icons_svelte: string;
	...
	export const npm_package_dependencies_rehype_unwrap_images: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_carbon_icons_svelte: string;
		...
		npm_package_dependencies_rehype_unwrap_images: string;
		rvm_bin_path: string;
